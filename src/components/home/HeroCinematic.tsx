...
import iconRadioAsset from '@/assets/icons-3d/noir-radio.png.asset.json';
const iconRadio = iconRadioAsset.url;
import iconHelmet from '@/assets/icons-3d/noir-helmet.png';
import iconHandcuffs from '@/assets/icons-3d/noir-handcuffs.png';
import agentFigureAsset from '@/assets/tactical-agent-figure.png.asset.json';
const agentFigure = agentFigureAsset.url;
