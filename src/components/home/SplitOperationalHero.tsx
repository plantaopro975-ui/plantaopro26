    ...
    <section className="relative mx-auto w-full max-w-[1600px] flex flex-col h-full min-h-0">
      ...
      >
        ...
        <div className="relative grid gap-3 sm:gap-4 px-3 sm:px-5 pt-2 pb-0 md:grid-cols-[0.95fr_1.05fr] items-start shrink-0">
          ...
          {/* RIGHT — Agent 3D */}
          <div className="relative flex items-end justify-center min-h-[clamp(110px,16vh,220px)] order-first md:order-none z-30 overflow-visible pb-0 -mb-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-2" style={{ perspective: '900px' }}>
            ...
            {TEAMS.map((t, idx) => {
              ...
              <button
                ...
                className={cn(
                  'group relative flex h-[clamp(120px,20vh,170px)] flex-col overflow-hidden rounded-xl border text-left bg-transparent isolate',
