            ...
            >
              ...
              <picture className="relative block h-full aspect-square leading-[0] translate-y-3 min-[390px]:translate-y-4 sm:translate-y-0">
                ...
                <img
                  ...
                  width={1024}
                  height={1024}
                  className="block h-full w-auto object-contain object-left-bottom sm:object-bottom drop-shadow-[0_10px_14px_rgba(0,0,0,0.7)] select-none scale-[1.04] sm:scale-[1.04] lg:scale-[1.62] xl:scale-[1.82] 2xl:scale-[1.95] origin-bottom-left"
                  draggable={false}
                />
                <span
                  aria-hidden
                  className="pointer-events-none absolute inset-0 scale-[1.04] sm:scale-[1.04] lg:scale-[1.62] xl:scale-[1.82] 2xl:scale-[1.95] origin-bottom-left"
              ...
              <picture className="relative z-50 block h-full leading-[0] flex items-end -ml-2 sm:ml-0">
                ...
                <img
                  ...
                  width={1024}
                  height={1024}
                  className="block h-full max-h-full w-auto object-contain object-bottom drop-shadow-[0_10px_14px_rgba(0,0,0,0.7)] select-none sm:-ml-2 scale-[1.04] sm:scale-[1.04] lg:scale-[1.28] xl:scale-[1.38] 2xl:scale-[1.46] origin-bottom sm:origin-bottom"
                  draggable={false}
                />
