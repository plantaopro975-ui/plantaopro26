            ...
            >
              ...
              <picture className="relative block h-full aspect-square leading-[0] translate-y-3 min-[390px]:translate-y-4 sm:translate-y-0 lg:translate-y-5 xl:translate-y-7">
                ...
                <img
                  ...
                  width={1024}
                  height={1024}
                  className="block h-full w-auto object-contain object-left-bottom sm:object-bottom drop-shadow-[0_10px_14px_rgba(0,0,0,0.7)] select-none scale-[1.22] sm:scale-[1.04] lg:scale-[1.10] xl:scale-[1.14] 2xl:scale-[1.20] origin-bottom-left"
                  draggable={false}
                />
                <span
                  aria-hidden
                  className="pointer-events-none absolute inset-0 scale-[1.22] sm:scale-[1.04] lg:scale-[1.10] xl:scale-[1.14] 2xl:scale-[1.20] origin-bottom-left"
                >
                  <span
                    aria-hidden
              ...
              <picture className="relative z-50 block h-full leading-[0] flex items-end -ml-2 sm:ml-0">
                ...
                <img
                  ...
                  width={1024}
                  height={1024}
                  className="block h-full max-h-full w-auto object-contain object-bottom drop-shadow-[0_10px_14px_rgba(0,0,0,0.7)] select-none sm:-ml-2 scale-[1.04] sm:scale-[1.06] lg:scale-[1.14] xl:scale-[1.20] translate-y-0 lg:translate-y-5 xl:translate-y-7 origin-bottom sm:origin-bottom"
                  draggable={false}
                />
