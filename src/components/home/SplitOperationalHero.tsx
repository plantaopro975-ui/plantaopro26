    ...
    <section className="relative mx-auto w-full max-w-[1600px] flex flex-col h-full min-h-0">
      ...
      >
        ...
        <div className="relative grid gap-3 p-3 sm:p-4 lg:grid-cols-[1fr_1.1fr_0.9fr] items-center flex-1 min-h-0">
          ...
          {/* CENTER — Agent 3D */}
          <div className="relative flex items-end justify-center h-full min-h-[180px] order-first lg:order-none z-30 translate-y-8 sm:translate-y-12 lg:translate-y-16">
            <svg
              aria-hidden
              viewBox="0 0 400 400"
