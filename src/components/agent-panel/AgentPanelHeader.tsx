        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1.5">
              ...
              <Tooltip delayDuration={200}>
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    <Icon3D name="gift" size={24} fallbackColor="rgb(251 191 36)" className="group-hover:scale-110 transition-transform duration-300" />
            ...
            <TooltipProvider>
              <Tooltip delayDuration={200}>
                <TooltipTrigger asChild>
                  ...
                  >
                    <Icon3D name="refresh" size={24} fallbackColor="rgb(52 211 153)" className="group-hover:rotate-180 transition-transform duration-500" />
                  </button>
                </TooltipTrigger>
            ...
            >
              ...
              <Icon3D name="logout" size={20} fallbackColor="white" className="group-hover:translate-x-0.5 transition-transform duration-300" />
