...
export default function Index() {
  ...
  return (
    ...
    <>
      <div
        className="home-typo min-h-full h-full max-h-[100dvh] flex-1 flex flex-col bg-background relative overflow-x-hidden overflow-y-auto overscroll-contain home-compact"
        style={{
