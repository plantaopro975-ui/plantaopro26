      ...
      <header className="relative z-20 flex min-h-0 flex-1 flex-col sm:overflow-hidden">
        ...
        {(() => {
          ...
          const wrap = (child: JSX.Element, extra = '') => (
            <div
              className={cn('w-full max-w-6xl sm:max-w-4xl lg:max-w-5xl mx-auto sm:px-8 lg:px-16 xl:px-24', extra)}
              style={{ paddingLeft: 'var(--home-pad-x)', paddingRight: 'var(--home-pad-x)' }}
            >
              {child}
            </div>
          ...
          const blocks: Record<HomeCardId, { node: JSX.Element; grow?: boolean } | null> = {
            ...
            hero: {
              ...
              node: (
                <div
                  className="w-full max-w-6xl sm:max-w-4xl lg:max-w-5xl xl:max-w-5xl mx-auto sm:h-full sm:px-8 lg:px-16 xl:px-24"
                  style={{ paddingLeft: 'var(--home-pad-x)', paddingRight: 'var(--home-pad-x)' }}
                >
