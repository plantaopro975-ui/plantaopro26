...
export default function Index() {
  ...
  return (
    ...
    <>
      <div
        className="home-typo min-h-full flex flex-col bg-background relative overflow-x-hidden overflow-y-auto sm:overflow-y-visible overscroll-contain home-compact"
        style={{
