      ...
      <div className="flex-1 flex flex-col h-[100dvh] overflow-hidden">
        <main className={`flex-1 px-1.5 py-1 sm:p-2 md:p-3 lg:p-4 overflow-y-auto overflow-x-hidden overscroll-y-auto scroll-smooth pb-safe ${showLicenseWarning ? 'pt-28' : ''}`}>
          <div className="max-w-7xl mx-auto space-y-1.5 sm:space-y-2 md:space-y-3 animate-fade-in pb-2 sm:pb-4">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-1.5 sm:space-y-2">
              <div className="bg-gradient-to-br from-slate-900/98 via-slate-800/95 to-slate-900/98 rounded-lg sm:rounded-xl border border-amber-500/20 sm:border-2 sm:border-amber-500/30 shadow-xl backdrop-blur-md p-1.5 sm:p-2 md:p-3">
                {/* Control Panel Header - Ultra Compact on Mobile */}
                <div className="flex items-center justify-between mb-1.5 sm:mb-2 px-0.5">
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    <div className="p-1 sm:p-1.5 bg-gradient-to-br from-amber-500 to-orange-600 rounded-md sm:rounded-lg shadow-lg">
                      <Shield className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-black" />
                    </div>
                    <div>
                      <h2 className="text-[11px] sm:text-sm md:text-base font-bold text-amber-100 tracking-wide leading-tight">PAINEL DE CONTROLE</h2>
                      <p className="text-[8px] sm:text-[10px] text-amber-400/70 uppercase tracking-widest hidden xs:block">Sistema Operacional</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-0.5 sm:gap-1">
                    <Zap className="h-3 w-3 sm:h-4 sm:w-4 text-amber-400 animate-pulse" />
                    <span className="text-[8px] sm:text-[10px] text-emerald-400 font-medium">ATIVO</span>
                  </div>
                </div>
                
                {/* Tabs Grid - Ultra Compact on Mobile */}
                <TabsList className="bg-gradient-to-br from-slate-800/80 via-slate-900/70 to-slate-800/80 border border-amber-500/15 sm:border-2 sm:border-amber-500/20 p-1.5 sm:p-2 md:p-2.5 h-auto grid grid-cols-5 lg:grid-cols-9 gap-1 sm:gap-1.5 md:gap-2 rounded-md sm:rounded-lg shadow-inner">
                  <TabsTrigger 
                    value="equipe" 
                    className="flex flex-col items-center justify-center gap-0.5 text-[9px] sm:text-[10px] md:text-sm p-2 sm:p-2.5 md:p-3 data-[state=active]:bg-gradient-to-br data-[state=active]:from-amber-400 data-[state=active]:via-amber-500 data-[state=active]:to-orange-600 data-[state=active]:text-black data-[state=active]:shadow-md data-[state=active]:shadow-amber-500/20 data-[state=active]:scale-[1.02] rounded-md sm:rounded-lg font-semibold transition-all duration-200 hover:bg-amber-500/15 min-h-[44px] sm:min-h-[52px] md:min-h-[64px] border border-slate-600/40 data-[state=active]:border-amber-300 text-amber-200/80 hover:text-amber-100"
                  >
                    <Users className="h-4 w-4 sm:h-5 sm:w-5" />
                    <span className="tracking-wide leading-none">Equipe</span>
                  </TabsTrigger>
                  
                  <TabsTrigger 
                    value="plantoes" 
                    className="flex flex-col items-center justify-center gap-0.5 text-[9px] sm:text-[10px] md:text-sm p-2 sm:p-2.5 md:p-3 data-[state=active]:bg-gradient-to-br data-[state=active]:from-orange-400 data-[state=active]:via-orange-500 data-[state=active]:to-red-600 data-[state=active]:text-white data-[state=active]:shadow-md data-[state=active]:shadow-orange-500/20 data-[state=active]:scale-[1.02] rounded-md sm:rounded-lg font-semibold transition-all duration-200 hover:bg-orange-500/15 min-h-[44px] sm:min-h-[52px] md:min-h-[64px] border border-slate-600/40 data-[state=active]:border-orange-300 text-orange-200/80 hover:text-orange-100"
                  >
                    <Calendar className="h-4 w-4 sm:h-5 sm:w-5" />
                    <span className="tracking-wide leading-none">Plantões</span>
                  </TabsTrigger>
                  
                  <TabsTrigger 
                    value="bh" 
                    className="flex flex-col items-center justify-center gap-0.5 text-[9px] sm:text-[10px] md:text-sm p-2 sm:p-2.5 md:p-3 data-[state=active]:bg-gradient-to-br data-[state=active]:from-emerald-400 data-[state=active]:via-green-500 data-[state=active]:to-teal-600 data-[state=active]:text-black data-[state=active]:shadow-md data-[state=active]:shadow-emerald-500/20 data-[state=active]:scale-[1.02] rounded-md sm:rounded-lg font-semibold transition-all duration-200 hover:bg-emerald-500/15 min-h-[44px] sm:min-h-[52px] md:min-h-[64px] border border-slate-600/40 data-[state=active]:border-emerald-300 text-emerald-200/80 hover:text-emerald-100"
                  >
                    <Clock className="h-4 w-4 sm:h-5 sm:w-5" />
                    <span className="tracking-wide leading-none">BH</span>
                  </TabsTrigger>
                  
                  <TabsTrigger 
                    value="folgas" 
                    className="flex flex-col items-center justify-center gap-0.5 text-[9px] sm:text-[10px] md:text-sm p-2 sm:p-2.5 md:p-3 data-[state=active]:bg-gradient-to-br data-[state=active]:from-purple-400 data-[state=active]:via-violet-500 data-[state=active]:to-indigo-600 data-[state=active]:text-white data-[state=active]:shadow-md data-[state=active]:shadow-purple-500/20 data-[state=active]:scale-[1.02] rounded-md sm:rounded-lg font-semibold transition-all duration-200 hover:bg-purple-500/15 min-h-[44px] sm:min-h-[52px] md:min-h-[64px] border border-slate-600/40 data-[state=active]:border-purple-300 text-purple-200/80 hover:text-purple-100"
                  >
                    <CalendarOff className="h-4 w-4 sm:h-5 sm:w-5" />
                    <span className="tracking-wide leading-none">Folgas</span>
                  </TabsTrigger>
                  
                  <TabsTrigger 
                    value="agenda" 
                    className="flex flex-col items-center justify-center gap-0 text-[7px] sm:text-[9px] md:text-xs p-1 sm:p-1.5 md:p-2 data-[state=active]:bg-gradient-to-br data-[state=active]:from-cyan-400 data-[state=active]:via-sky-500 data-[state=active]:to-blue-600 data-[state=active]:text-black data-[state=active]:shadow-md data-[state=active]:shadow-cyan-500/20 data-[state=active]:scale-[1.02] rounded-md sm:rounded-lg font-semibold transition-all duration-200 hover:bg-cyan-500/15 min-h-[32px] sm:min-h-[40px] md:min-h-[52px] border border-slate-600/40 data-[state=active]:border-cyan-300 text-cyan-200/70 hover:text-cyan-100"
                  >
                    <CalendarDays className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
                    <span className="tracking-wide leading-none">Agenda</span>
                  </TabsTrigger>
                  
                  <TabsTrigger 
                    value="planejador" 
                    className="flex flex-col items-center justify-center gap-0 text-[7px] sm:text-[9px] md:text-xs p-1 sm:p-1.5 md:p-2 data-[state=active]:bg-gradient-to-br data-[state=active]:from-rose-400 data-[state=active]:via-red-500 data-[state=active]:to-pink-600 data-[state=active]:text-white data-[state=active]:shadow-md data-[state=active]:shadow-rose-500/20 data-[state=active]:scale-[1.02] rounded-md sm:rounded-lg font-semibold transition-all duration-200 hover:bg-rose-500/15 min-h-[32px] sm:min-h-[40px] md:min-h-[52px] border border-slate-600/40 data-[state=active]:border-rose-300 text-rose-200/70 hover:text-rose-100"
                  >
                    <Calculator className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
                    <span className="tracking-wide leading-none">Plan</span>
                  </TabsTrigger>
                  
                  <TabsTrigger 
                    value="permutas" 
                    className="flex flex-col items-center justify-center gap-0 text-[7px] sm:text-[9px] md:text-xs p-1 sm:p-1.5 md:p-2 data-[state=active]:bg-gradient-to-br data-[state=active]:from-yellow-400 data-[state=active]:via-amber-500 data-[state=active]:to-orange-600 data-[state=active]:text-black data-[state=active]:shadow-md data-[state=active]:shadow-yellow-500/20 data-[state=active]:scale-[1.02] rounded-md sm:rounded-lg font-semibold transition-all duration-200 hover:bg-yellow-500/15 min-h-[32px] sm:min-h-[40px] md:min-h-[52px] border border-slate-600/40 data-[state=active]:border-yellow-300 text-yellow-200/70 hover:text-yellow-100"
                  >
                    <ArrowRightLeft className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
                    <span className="tracking-wide leading-none">Troca</span>
                  </TabsTrigger>
                  
                  <TabsTrigger 
                    value="chat" 
                    className="flex flex-col items-center justify-center gap-0 text-[7px] sm:text-[9px] md:text-xs p-1 sm:p-1.5 md:p-2 data-[state=active]:bg-gradient-to-br data-[state=active]:from-blue-400 data-[state=active]:via-indigo-500 data-[state=active]:to-violet-600 data-[state=active]:text-white data-[state=active]:shadow-md data-[state=active]:shadow-blue-500/20 data-[state=active]:scale-[1.02] rounded-md sm:rounded-lg font-semibold transition-all duration-200 hover:bg-blue-500/15 min-h-[32px] sm:min-h-[40px] md:min-h-[52px] border border-slate-600/40 data-[state=active]:border-blue-300 text-blue-200/70 hover:text-blue-100"
                  >
                    <MessageCircle className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
                    <span className="tracking-wide leading-none">Chat</span>
                  </TabsTrigger>
                  
                  <TabsTrigger 
                    value="config" 
                    className="flex flex-col items-center justify-center gap-0 text-[7px] sm:text-[9px] md:text-xs p-1 sm:p-1.5 md:p-2 data-[state=active]:bg-gradient-to-br data-[state=active]:from-slate-400 data-[state=active]:via-gray-500 data-[state=active]:to-zinc-600 data-[state=active]:text-white data-[state=active]:shadow-md data-[state=active]:shadow-slate-500/20 data-[state=active]:scale-[1.02] rounded-md sm:rounded-lg font-semibold transition-all duration-200 hover:bg-slate-500/15 min-h-[32px] sm:min-h-[40px] md:min-h-[52px] border border-slate-600/40 data-[state=active]:border-slate-300 text-slate-200/70 hover:text-slate-100"
                  >
                    <Settings className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
                    <span className="tracking-wide leading-none">Config</span>
                  </TabsTrigger>
                </TabsList>
              </div>
