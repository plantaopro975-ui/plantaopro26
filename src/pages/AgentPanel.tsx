                ...
                <div className={compact ? 'p-1.5 md:p-2' : 'p-2 md:p-2.5'}>
                  <TabsList className={cn(
                    ...
                    >
                      ...
                      <span className="text-xs md:text-sm font-bold text-yellow-200 group-data-[state=active]:text-black tracking-wide">Permutas</span>
                    </TabsTrigger>
                    
                    {/* Chat Tab */}
                    <TabsTrigger 
                      value="chat" 
                      className="group flex flex-col items-center justify-center gap-1 p-1.5 md:p-2 rounded-lg md:rounded-xl font-bold transition-all duration-300 min-h-[50px] md:min-h-[58px] border border-slate-600/50 bg-slate-800/50 hover:bg-blue-500/15 hover:border-blue-500/50 data-[state=active]:bg-gradient-to-br data-[state=active]:from-blue-400 data-[state=active]:via-indigo-500 data-[state=active]:to-violet-600 data-[state=active]:text-white data-[state=active]:shadow-xl data-[state=active]:shadow-blue-500/40 data-[state=active]:border-blue-300 data-[state=active]:scale-[1.02]"
                    >
                      <MessageCircle className="h-4 w-4 md:h-[18px] md:w-[18px] text-blue-400 group-data-[state=active]:text-white transition-colors" />
                      <span className="text-xs md:text-sm font-bold text-blue-200 group-data-[state=active]:text-white tracking-wide">Chat</span>
                    </TabsTrigger>
                    
                    {/* Config Tab */}
                    <TabsTrigger 
                      value="config" 
                      className="group flex flex-col items-center justify-center gap-1 p-1.5 md:p-2 rounded-lg md:rounded-xl font-bold transition-all duration-300 min-h-[50px] md:min-h-[58px] border border-slate-600/50 bg-slate-800/50 hover:bg-slate-500/15 hover:border-slate-400/50 data-[state=active]:bg-gradient-to-br data-[state=active]:from-slate-400 data-[state=active]:via-gray-500 data-[state=active]:to-zinc-600 data-[state=active]:text-white data-[state=active]:shadow-xl data-[state=active]:shadow-slate-500/40 data-[state=active]:border-slate-300 data-[state=active]:scale-[1.02]"
                    >
                      <Settings className="h-4 w-4 md:h-[18px] md:w-[18px] text-slate-400 group-data-[state=active]:text-white transition-colors" />
                      <span className="text-xs md:text-sm font-bold text-slate-200 group-data-[state=active]:text-white tracking-wide">Config</span>
                    </TabsTrigger>
                  </TabsList>
                </div>
              </div>
